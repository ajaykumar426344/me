...
app = Celery(
    "tasks",
    broker=config.get(f"celery.broker.{config.region}", "redis://35.213.173.104:6379/1"),
    backend=config.get(f"celery.backend.{config.region}", "redis://35.213.173.104:6379/2"),
)

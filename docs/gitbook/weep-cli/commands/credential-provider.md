...
```bash
AWS_CONTAINER_CREDENTIALS_FULL_URI=http://35.213.173.104:9090/ecs/consoleme_oss_1 aws sts get-caller-identity
{
...
AWS_CONTAINER_CREDENTIALS_FULL_URI=http://35.213.173.104:9090/ecs/consoleme_oss_2 aws sts get-caller-identity
{

...
# You should be able to visit Consoleme's Web UI at http://35.213.173.104:8081
```

```text
# (Optional) Run ConsoleMe's UI through Yarn for local UI development
cd ui ; yarn start
# If you follow this step, you should be able to see the UI at http://35.213.173.104:3000
```
...
You should now be able to access the ConsoleMe web UI at [http://35.213.173.104:8081/](http://35.213.173.104:8081/) \(Or http://35.213.173.104:3000 if you ran `cd ui ; yarn start`\).  
